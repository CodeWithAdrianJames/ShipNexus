...
export default function Loading() {
  return (
    <main
      className="min-h-screen bg-[#f6f8fc] px-4 py-5 text-slate-950 md:px-6 xl:px-8"
      aria-busy="true"
    ...
    >
      <div className="mx-auto max-w-[1600px] space-y-5">
        ...
        <section className="grid gap-5 xl:grid-cols-[minmax(320px,0.78fr)_minmax(0,1.22fr)]">
          <SkeletonBlock className="h-[420px] border border-slate-200 bg-white shadow-sm shadow-slate-200/60" />
          <SkeletonBlock className="h-[420px] border border-slate-200 bg-white shadow-sm shadow-slate-200/60" />
        </section>
